<div class="container mt-4">
    <div class="mt-4 m-4 d-flex justify-content-between">
        <div class="d-flex justify-content-center align-items-center">
            <h1 class="display-3"><strong>Coffee</strong></h1>
        </div>
        <?php 
            require_once('database/database.php');
            $products = getCoffeeOne();
            foreach($products as $product):     
        ?>
        <a href="model/details.php?postId=<?= $product['postID'] ?>&place=coffee" class="card bg-dark text-white border-0 w-75 h-75">
    ...
    <div class="d-flex">
        <div class="mt-4 d-flex flex-column" style='width: 65%;'>
            ...
            <a href="model/details.php?postId=<?= $product['postID'] ?>&place=coffee" class="card text-dark" style="width: 42rem;">
                <div class="card-body">
        ...
        <div class="d-flex flex-column align-items-center mt-4" style='width: 35%;'>
            <div class="bg-light w-100 ml-4 h-50 border">
                ...
                <?php 
                    require_once('database/database.php');
                    $products = getCoffeeSort();
                    foreach($products as $product):  
                ?>
                <div class="card mb-3 mt-4 border-0" style="max-width: 550px;">
                    <a href="model/details.php?postId=<?= $product['postID'] ?>&place=coffee" class="d-flex no-gutters text-dark">
